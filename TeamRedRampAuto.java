...
@Autonomous(name="11368 Red Ramp Auto", group="Team code")
public class TeamRedRampAuto extends LinearOpMode {
	...
	public void runOpMode() throws InterruptedException {
		...
		*/
		...
		sleep(5000);
		driveToEncoder(TURN_SPEED, -14, -14, 5);//Turn 90 degrees left
		sleep(5000);
		driveToEncoder(DRIVE_SPEED, -30, 30, 5);//Drive forward
		sleep(5000);
