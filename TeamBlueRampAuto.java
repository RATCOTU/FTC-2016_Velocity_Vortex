...
@Autonomous(name="11368 Blue Ramp Auto", group="Team code")
public class TeamBlueRampAuto extends LinearOpMode {
	...
	public void runOpMode() throws InterruptedException {
		...
		*/
		...
		driveToEncoder(DRIVE_SPEED, -30, 30, 5);//Drive forward
		sleep(5000);
		driveToEncoder(TURN_SPEED, -14, -14, 5);//Turn 90 degrees right
		sleep(5000);
		driveToEncoder(DRIVE_SPEED, -30, 30, 5);//Drive forward
		sleep(5000);
		robot.intake.setPower(-1.0);//Release balls into corner vortex
		sleep(5000);
		robot.intake.setPower(0);//Stop ball mechanism
